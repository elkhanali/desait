    ...
    <div class="row">
      ...
      <div class="col-md-8">
        ...
        <div class="card card-primary ">
          ...
          <!-- /.card-header -->
          <!-- form start -->
          <form method="post" action="{{route('employers.index.store')}}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="card-body">
              ...
              <div class="form-group">
                <label for="duty">Employer Duty</label>
                <input type="text" name="duty" value="" class="form-control" id="duty" placeholder="Enter duty">
              </div>
              <div class="form-group">
